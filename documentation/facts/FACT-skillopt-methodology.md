...
After all four individual gates pass, eight distinct cross-skill workflows run on Codex across all variants (24 evaluations). The SkillOpt bundle must reach mean ≥85, at least 20/24 hard passes, exceed both comparators by 3 points, retain hard-pass counts, and stay within 5 family mean points with zero critical failures.
