...
tags: [requirements, semantic-inventory, cli, mcp, sync, e2e]
...
verification_receipts:
  - version: kibi.verification-receipt.v1
    ...
    runner: node
    command: >-
      tsc -p documentation/tests/e2e/packed/tsconfig.e2e.json --outDir <mktemp> && NODE_OPTIONS=--enable-source-maps node --test --test-concurrency=1 <mktemp>/proposition-complete-ingestion.test.js
    scope: end_to_end
    outcome: passed
