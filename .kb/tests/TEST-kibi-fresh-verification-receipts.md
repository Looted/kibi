    ...
    proof_results:
      - symbol_id: SYM-test-packed-fresh-verification-receipts
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-96c5aa5d02bc0ca1de6f00f2
    test_id: TEST-kibi-fresh-verification-receipts
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-packed-fresh-verification-receipts
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-28810f530057db8df6f9e4b4
    test_id: TEST-kibi-fresh-verification-receipts
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-packed-fresh-verification-receipts
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-8b8bfa96c2bf692e74b8427c
    test_id: TEST-kibi-fresh-verification-receipts
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-packed-fresh-verification-receipts
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-aedeec898452c1d96b26d603
    test_id: TEST-kibi-fresh-verification-receipts
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-packed-fresh-verification-receipts
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-7cbb43106f1ddebdc77d0c11
    test_id: TEST-kibi-fresh-verification-receipts
    scope: end_to_end
    outcome: passed
