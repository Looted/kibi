    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-skills-resource-discoverability
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-4a4df39e02cc851b88f5bf17
    test_id: TEST-mcp-skills-resource-discoverability
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-skills-resource-discoverability
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-c93b7d8a9334c2c3ca3bf503
    test_id: TEST-mcp-skills-resource-discoverability
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-skills-resource-discoverability
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-308195a07e56a935a2236ccd
    test_id: TEST-mcp-skills-resource-discoverability
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-skills-resource-discoverability
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-8eacc35b704140a0db017ca8
    test_id: TEST-mcp-skills-resource-discoverability
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-skills-resource-discoverability
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-84de46340f583cd619355ec6
    test_id: TEST-mcp-skills-resource-discoverability
    scope: end_to_end
    outcome: passed
