    ...
    proof_results:
      - symbol_id: SYM-test-packed-fresh-verification-receipts
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-1ba7ab3020bf499991cad4d7
    test_id: TEST-kibi-verification-evidence-contract
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-packed-fresh-verification-receipts
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-471e3931ba965389a13d021d
    test_id: TEST-kibi-verification-evidence-contract
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-packed-fresh-verification-receipts
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-9fc2ba4ab1456c9ab55903b8
    test_id: TEST-kibi-verification-evidence-contract
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-packed-fresh-verification-receipts
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-cedca344e5dff9bd17564ba2
    test_id: TEST-kibi-verification-evidence-contract
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-packed-fresh-verification-receipts
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-805e9debcbbd80e9603afd23
    test_id: TEST-kibi-verification-evidence-contract
    scope: end_to_end
    outcome: passed
