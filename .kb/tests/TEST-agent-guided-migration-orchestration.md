    ...
    proof_results:
      - symbol_id: SYM-e2e-test-agent-guided-migration-orchestration
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-b0fcbbc1f9b4f64c8ba8ec6e
    test_id: TEST-agent-guided-migration-orchestration
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-agent-guided-migration-orchestration
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-cd0a98e06d1e572219622ce6
    test_id: TEST-agent-guided-migration-orchestration
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-agent-guided-migration-orchestration
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-972c49f15234536eed32f137
    test_id: TEST-agent-guided-migration-orchestration
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-agent-guided-migration-orchestration
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-36086a43bedf5b6d37c3a8c0
    test_id: TEST-agent-guided-migration-orchestration
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-agent-guided-migration-orchestration
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-479aa997b7a2cc5f42e0488d
    test_id: TEST-agent-guided-migration-orchestration
    scope: end_to_end
    outcome: passed
