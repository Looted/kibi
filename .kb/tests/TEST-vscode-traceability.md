    ...
    proof_results:
      - symbol_id: SYM-e2e-test-vscode-traceability
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-8510b565fda93d8d57986ddc
    test_id: TEST-vscode-traceability
    scope: integration
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-vscode-traceability
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-0c4d1d1802e40e5ac70e15cb
    test_id: TEST-vscode-traceability
    scope: integration
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-vscode-traceability
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-e0f1e6b891367ab3178e7d25
    test_id: TEST-vscode-traceability
    scope: integration
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-vscode-traceability
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-c6a057fea23bba14f70bcbb3
    test_id: TEST-vscode-traceability
    scope: integration
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-vscode-traceability
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-4ec66a732bcc471b0aeafc00
    test_id: TEST-vscode-traceability
    scope: integration
    outcome: passed
