    ...
    proof_results:
      - symbol_id: SYM-e2e-packed-cli-check
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-63a12cf7f3c286e4885cd4da
    test_id: TEST-004
    scope: end_to_end
    outcome: failed
    ...
    gaps:
      - symbol_id: SYM-e2e-packed-cli-check
        target: default
        reason: 'run did not pass (outcome: failed); this obligation''s own result outcome is ''failed''; failing member result(s): SYM-e2e-test-001 (failed), SYM-e2e-test-003 (failed), SYM-e2e-test-005 (failed), SYM-test-packed-default-branch-sync-hooks (failed), SYM-test-packed-post-merge-sync (failed) +109 more'
  - version: kibi.proof-receipt.v1
    receipt_id: PR-01e9c4e5d8b9dbefe0a6135f
    test_id: TEST-004
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-packed-cli-check
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-e2157eb8429eb3c48c9454aa
    test_id: TEST-004
    scope: end_to_end
    outcome: passed
