...
proof_receipts:
    ...
    proof_results:
      ...
      - symbol_id: SYM-test-packed-post-merge-sync
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-ee0a37b19f2d080fa7cce3c7
    test_id: TEST-006
    scope: end_to_end
    outcome: failed
    ...
    gaps:
      - symbol_id: SYM-test-packed-default-branch-sync-hooks
        target: default
        reason: 'run did not pass (outcome: failed); this obligation''s own result outcome is ''failed''; failing member result(s): SYM-e2e-test-001 (failed), SYM-e2e-test-003 (failed), SYM-e2e-packed-cli-check (failed), SYM-e2e-test-005 (failed), SYM-test-packed-post-merge-sync (failed) +106 more'
      - symbol_id: SYM-test-packed-post-merge-sync
        target: default
  ...
  - version: kibi.proof-receipt.v1
    receipt_id: PR-899b3fed4a2d6e454312b844
    test_id: TEST-006
    scope: end_to_end
    outcome: passed
