    ...
    proof_results:
      - symbol_id: SYM-test-kibi-change-to-proof-plan-compiler
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-0855fb6236a7774ce60e2428
    test_id: TEST-kibi-change-to-proof-plan-compiler
    scope: integration
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-kibi-change-to-proof-plan-compiler
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-e444a4060a44d13546055337
    test_id: TEST-kibi-change-to-proof-plan-compiler
    scope: integration
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-kibi-change-to-proof-plan-compiler
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-59df9d6a2b86a5369abf9ec6
    test_id: TEST-kibi-change-to-proof-plan-compiler
    scope: integration
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-kibi-change-to-proof-plan-compiler
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-47a29806eddf7e3dd739688c
    test_id: TEST-kibi-change-to-proof-plan-compiler
    scope: integration
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-kibi-change-to-proof-plan-compiler
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-c6d7fe9ecea9e507357f80aa
    test_id: TEST-kibi-change-to-proof-plan-compiler
    scope: integration
    outcome: passed
