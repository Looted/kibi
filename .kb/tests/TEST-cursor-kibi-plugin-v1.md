    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-kibi-plugin-v1
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-1d28ba1ab970a618e47e632e
    test_id: TEST-cursor-kibi-plugin-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-kibi-plugin-v1
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-a3f0e424cf2d77ff24c1cdaf
    test_id: TEST-cursor-kibi-plugin-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-kibi-plugin-v1
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-3079ca773f706356ff0372dc
    test_id: TEST-cursor-kibi-plugin-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-kibi-plugin-v1
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-0dce5cee42f86a75e8db44b2
    test_id: TEST-cursor-kibi-plugin-v1
    scope: end_to_end
    outcome: passed
