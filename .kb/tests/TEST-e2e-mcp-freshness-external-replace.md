...
proof_receipts:
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-freshness-external-replace
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-ff4e37fa5e58c6359cde0553
    test_id: TEST-e2e-mcp-freshness-external-replace
    scope: end_to_end
    outcome: failed
  ...
  - version: kibi.proof-receipt.v1
    receipt_id: PR-96189320844a71c6c6a00209
    test_id: TEST-e2e-mcp-freshness-external-replace
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-freshness-external-replace
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-a5415365b30e345c9f8eeccf
    test_id: TEST-e2e-mcp-freshness-external-replace
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-freshness-external-replace
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-74ae6fff898a2865524feda6
    test_id: TEST-e2e-mcp-freshness-external-replace
    scope: end_to_end
    outcome: failed
    ...
    gaps:
      - symbol_id: SYM-e2e-test-mcp-freshness-external-replace
        ...
        reason: 'run did not pass (outcome: failed); this obligation''s own result outcome is ''failed''; failing member result(s): SYM-e2e-test-001 (failed), SYM-e2e-test-003 (failed), SYM-e2e-packed-cli-check (failed), SYM-e2e-test-005 (failed), SYM-test-packed-default-branch-sync-hooks (failed) +105 more'
  - version: kibi.proof-receipt.v1
    receipt_id: PR-3a5558092f5985f5b605f150
    test_id: TEST-e2e-mcp-freshness-external-replace
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-freshness-external-replace
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-2e9e8e1dde40100f79654a9d
    test_id: TEST-e2e-mcp-freshness-external-replace
    scope: end_to_end
    outcome: passed
