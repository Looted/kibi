    ...
    proof_results:
      - symbol_id: SYM-e2e-test-skillopt-predicate-first-requirements
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-3f0465cd17fcb8329a0aa9ce
    test_id: TEST-skillopt-predicate-first-requirements
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-skillopt-predicate-first-requirements
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-53b3b4501e3df4890f4247b7
    test_id: TEST-skillopt-predicate-first-requirements
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-skillopt-predicate-first-requirements
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-0fa392cbf9dd655b23e6bf9e
    test_id: TEST-skillopt-predicate-first-requirements
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-skillopt-predicate-first-requirements
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-83f62319f0e90c2965718222
    test_id: TEST-skillopt-predicate-first-requirements
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-skillopt-predicate-first-requirements
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-af2d9c6e25178d5e06a84671
    test_id: TEST-skillopt-predicate-first-requirements
    scope: end_to_end
    outcome: passed
