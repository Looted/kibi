    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-bootstrap-plan-apply
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-18ea4e0fa26bbbf7f9aef36d
    test_id: TEST-KIBI-BOOTSTRAP-PLAN-APPLY
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-bootstrap-plan-apply
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-e5b70222ed45186603e66ec2
    test_id: TEST-KIBI-BOOTSTRAP-PLAN-APPLY
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-bootstrap-plan-apply
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-31236867610dcddd6afb1cc1
    test_id: TEST-KIBI-BOOTSTRAP-PLAN-APPLY
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-bootstrap-plan-apply
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-733886eb81bc3a88f13d59af
    test_id: TEST-KIBI-BOOTSTRAP-PLAN-APPLY
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-bootstrap-plan-apply
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-6fafec9a10536e361a403419
    test_id: TEST-KIBI-BOOTSTRAP-PLAN-APPLY
    scope: end_to_end
    outcome: passed
