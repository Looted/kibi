    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-agent-plugin-v1
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-af75e38c27c7eaafc185e909
    test_id: TEST-cursor-agent-plugin-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-agent-plugin-v1
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-58f3d8012d639bbd3cf3ae7d
    test_id: TEST-cursor-agent-plugin-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-agent-plugin-v1
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-3b7939546f25eb4394a5be0e
    test_id: TEST-cursor-agent-plugin-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-agent-plugin-v1
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-6a2a1b67087b69efa748e2ed
    test_id: TEST-cursor-agent-plugin-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-agent-plugin-v1
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-610f4c974743c7297451936a
    test_id: TEST-cursor-agent-plugin-v1
    scope: end_to_end
    outcome: passed
