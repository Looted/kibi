    ...
    proof_results:
      - symbol_id: SYM-e2e-test-005
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-846ae120802304ca5fa92197
    test_id: TEST-005
    scope: end_to_end
    outcome: failed
    ...
    gaps:
      - symbol_id: SYM-e2e-test-005
        target: default
        reason: 'run did not pass (outcome: failed); this obligation''s own result outcome is ''failed''; failing member result(s): SYM-e2e-test-001 (failed), SYM-e2e-test-003 (failed), SYM-e2e-packed-cli-check (failed), SYM-test-packed-default-branch-sync-hooks (failed), SYM-test-packed-post-merge-sync (failed) +109 more'
  - version: kibi.proof-receipt.v1
    receipt_id: PR-bd15614459a722286710628c
    test_id: TEST-005
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-005
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-8bc156ed8c661456d77d2db2
    test_id: TEST-005
    scope: end_to_end
    outcome: passed
