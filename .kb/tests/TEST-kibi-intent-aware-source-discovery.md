    ...
    proof_results:
      - symbol_id: SYM-test-kibi-intent-aware-source-discovery
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-d34305582cbedfb841260aac
    test_id: TEST-kibi-intent-aware-source-discovery
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-kibi-intent-aware-source-discovery
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-71e65795c964883db3e9f229
    test_id: TEST-kibi-intent-aware-source-discovery
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-kibi-intent-aware-source-discovery
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-5ae5b3b659f2bbe105510efa
    test_id: TEST-kibi-intent-aware-source-discovery
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-kibi-intent-aware-source-discovery
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-b69265aa483ba6af53530435
    test_id: TEST-kibi-intent-aware-source-discovery
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-test-kibi-intent-aware-source-discovery
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-f4667b7e2605ebf211ec8903
    test_id: TEST-kibi-intent-aware-source-discovery
    scope: end_to_end
    outcome: passed
