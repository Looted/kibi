    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-kb-freshness
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-875bde9ff09eae9cafa76a83
    test_id: TEST-mcp-kb-freshness
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-kb-freshness
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-01cb3b6f00144df9acae2ddf
    test_id: TEST-mcp-kb-freshness
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-kb-freshness
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-2c51287b2206b8192e63ff35
    test_id: TEST-mcp-kb-freshness
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-kb-freshness
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-70a7a876f33d626406774de1
    test_id: TEST-mcp-kb-freshness
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-kb-freshness
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-e58f3531324408840fb1777d
    test_id: TEST-mcp-kb-freshness
    scope: end_to_end
    outcome: passed
