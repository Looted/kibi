    ...
    proof_results:
      - symbol_id: SYM-e2e-test-opencode-python-comment-routing
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-f2474c870f857f4bfeb065cd
    test_id: TEST-opencode-python-comment-routing
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-opencode-python-comment-routing
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-3153c57a4087e9add407bbfc
    test_id: TEST-opencode-python-comment-routing
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-opencode-python-comment-routing
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-bc11414cb70eafcdaf3011d3
    test_id: TEST-opencode-python-comment-routing
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-opencode-python-comment-routing
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-5cbfa65e3690af49242fdc4d
    test_id: TEST-opencode-python-comment-routing
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-opencode-python-comment-routing
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-42bfa4e9042b4d62e53080b5
    test_id: TEST-opencode-python-comment-routing
    scope: end_to_end
    outcome: passed
