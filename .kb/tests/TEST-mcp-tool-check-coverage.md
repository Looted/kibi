    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-tool-check-coverage
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-945e0db515935fcad89818e6
    test_id: TEST-mcp-tool-check-coverage
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-tool-check-coverage
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-051f25ef585a083060410e89
    test_id: TEST-mcp-tool-check-coverage
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-tool-check-coverage
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-981e2c2a166cb47abf3f9f30
    test_id: TEST-mcp-tool-check-coverage
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-tool-check-coverage
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-d0384ca6cfb5d5bb926ddf85
    test_id: TEST-mcp-tool-check-coverage
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-tool-check-coverage
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-3d2206fc4994eff35d846046
    test_id: TEST-mcp-tool-check-coverage
    scope: end_to_end
    outcome: passed
