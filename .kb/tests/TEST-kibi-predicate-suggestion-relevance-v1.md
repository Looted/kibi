    ...
    proof_results:
      - symbol_id: SYM-kibi-predicate-suggestion-relevance-e2e
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-a34a793ba9a56b29d03983cd
    test_id: TEST-kibi-predicate-suggestion-relevance-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-kibi-predicate-suggestion-relevance-e2e
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-c542aa87c2b1651828770774
    test_id: TEST-kibi-predicate-suggestion-relevance-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-kibi-predicate-suggestion-relevance-e2e
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-6923e32b03b73b7fe03ac596
    test_id: TEST-kibi-predicate-suggestion-relevance-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-kibi-predicate-suggestion-relevance-e2e
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-30b25561bfe5446760a579b0
    test_id: TEST-kibi-predicate-suggestion-relevance-v1
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-kibi-predicate-suggestion-relevance-e2e
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-f3237b2240154da562ce8a8a
    test_id: TEST-kibi-predicate-suggestion-relevance-v1
    scope: end_to_end
    outcome: passed
