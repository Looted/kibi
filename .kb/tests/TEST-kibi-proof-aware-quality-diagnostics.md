    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-proof-aware-quality-diagnostics
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-14c4f6b92eb3acba3a54c979
    test_id: TEST-kibi-proof-aware-quality-diagnostics
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-proof-aware-quality-diagnostics
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-546d6c512f58d3af005b030c
    test_id: TEST-kibi-proof-aware-quality-diagnostics
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-proof-aware-quality-diagnostics
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-6404c9349c895781118b3336
    test_id: TEST-kibi-proof-aware-quality-diagnostics
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-proof-aware-quality-diagnostics
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-3dac4d190f3800e1b6acf192
    test_id: TEST-kibi-proof-aware-quality-diagnostics
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-proof-aware-quality-diagnostics
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-d5483df7a521bf7e653e59a0
    test_id: TEST-kibi-proof-aware-quality-diagnostics
    scope: end_to_end
    outcome: passed
