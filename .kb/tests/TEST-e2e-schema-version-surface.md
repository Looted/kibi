---
title: Packed CLI exposes the current KB schema version
status: passing
...
proof_contract:
  ...
  required_proofs:
    - symbol_id: SYM-e2e-test-cli-schema-version-surface
      target: default
  success_policy: all_required_first_attempt
id: TEST-e2e-schema-version-surface
type: test
proof_receipts:
  - version: kibi.proof-receipt.v1
    receipt_id: PR-c65641d03b9bb127c646f24f
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    contract_hash: 917d8c0d204f88993958886f633f0a9421e6c2d89e444e5124e76423ae7487b7
    binding_hash: 0bc840edf8f2a9d1896a63e03cb846f6fc31f22a07bd374999d4cda11fbafbbb
    fingerprint: 1ec9d10fa085b0d11545b0706b906c620c3737ddaa7ff3ce2602598d94ed1c8a
    fingerprint_components:
      contract: 917d8c0d204f88993958886f633f0a9421e6c2d89e444e5124e76423ae7487b7
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-0beb86eb9d98930e129d35c4
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    contract_hash: 917d8c0d204f88993958886f633f0a9421e6c2d89e444e5124e76423ae7487b7
    binding_hash: 36a61dd0adab1b823a1d16133509c280b205d24d4739bb67f8047b7fafa58f45
    fingerprint: 1ec9d10fa085b0d11545b0706b906c620c3737ddaa7ff3ce2602598d94ed1c8a
    fingerprint_components:
      contract: 917d8c0d204f88993958886f633f0a9421e6c2d89e444e5124e76423ae7487b7
      integration: 41d3ed0ab7afab1838edccfd3c24450bd77214cd1a41cdc82378e69a99b2e84f
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-d5885823e5553397657d8c62
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: failed
  ...
  - version: kibi.proof-receipt.v1
    receipt_id: PR-2f494f73617710fbdd020656
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-df4199a35cf5d2f56b0a62f6
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-a558bd1a943b514832efd045
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: failed
  ...
  - version: kibi.proof-receipt.v1
    receipt_id: PR-d27152c4723746348de82678
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-8de0c26339648465d0d3d62f
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: failed
    ...
    gaps:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        reason: 'run did not pass (outcome: failed); this obligation''s own result outcome is ''failed''; failing member result(s): SYM-e2e-test-001 (failed), SYM-e2e-test-003 (failed), SYM-e2e-packed-cli-check (failed), SYM-e2e-test-005 (failed), SYM-test-packed-default-branch-sync-hooks (failed) +102 more'
  - version: kibi.proof-receipt.v1
    receipt_id: PR-28c19baf78f30e0ff1e36662
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: failed
    ...
    gaps:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        reason: 'run did not pass (outcome: failed); this obligation''s own result outcome is ''failed''; failing member result(s): SYM-e2e-test-001 (failed), SYM-e2e-test-003 (failed), SYM-e2e-packed-cli-check (failed), SYM-e2e-test-005 (failed), SYM-test-packed-default-branch-sync-hooks (failed) +102 more'
  - version: kibi.proof-receipt.v1
    receipt_id: PR-73e9cf5a4b52e82c4b5059eb
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: failed
    ...
    gaps:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        reason: 'run did not pass (outcome: failed); this obligation''s own result outcome is ''failed''; failing member result(s): SYM-e2e-test-001 (failed), SYM-e2e-test-003 (failed), SYM-e2e-packed-cli-check (failed), SYM-e2e-test-005 (failed), SYM-test-packed-default-branch-sync-hooks (failed) +102 more'
  - version: kibi.proof-receipt.v1
    receipt_id: PR-1760e9587fad8ce2cf439a0a
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-2e04ca6488c48e68edf62802
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-2dce47542a238368aec39b0b
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-28eac299d905166d7b0f1590
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-1db8c12d6397e4eccd12ea59
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: failed
  ...
  - version: kibi.proof-receipt.v1
    receipt_id: PR-4bf06ac5a12cd8e3a6f2884e
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-b38a5d36548ef05850274bba
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-schema-version-surface
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-1efa2607233b9cd5c513f40d
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: failed
  ...
  - version: kibi.proof-receipt.v1
    receipt_id: PR-d85a87013d5dbbf3b9e7dcab
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: failed
  ...
  - version: kibi.proof-receipt.v1
    receipt_id: PR-af7ec26054888bbb1de8f011
    test_id: TEST-e2e-schema-version-surface
    scope: end_to_end
    outcome: passed
...
Packed end-to-end regression for packed cli exposes the current kb schema version.
