    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-operation-interface-parity
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-b170008888dee589486e2180
    test_id: TEST-kibi-operation-interface-parity
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-operation-interface-parity
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-f3e93b2d8498544e851a86c9
    test_id: TEST-kibi-operation-interface-parity
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-operation-interface-parity
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-f9b7c1a38243af85ffd0ffb2
    test_id: TEST-kibi-operation-interface-parity
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-operation-interface-parity
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-776f89e59c8262aef884f634
    test_id: TEST-kibi-operation-interface-parity
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-kibi-operation-interface-parity
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-dd579d371eb8612a88b40152
    test_id: TEST-kibi-operation-interface-parity
    scope: end_to_end
    outcome: passed
