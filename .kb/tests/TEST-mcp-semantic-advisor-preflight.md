    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-semantic-advisor-preflight
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-5d2e3a4c90f2f1feeec9a64b
    test_id: TEST-mcp-semantic-advisor-preflight
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-semantic-advisor-preflight
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-9f70f5879c5e1048eff4ae24
    test_id: TEST-mcp-semantic-advisor-preflight
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-semantic-advisor-preflight
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-fb2faca665af3f4d80c62433
    test_id: TEST-mcp-semantic-advisor-preflight
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-semantic-advisor-preflight
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-16d1ff765932ebfb55543b24
    test_id: TEST-mcp-semantic-advisor-preflight
    scope: end_to_end
    outcome: passed
