    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-sync-discovery-readme-ignore
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-f56abd93722a525660247caa
    test_id: TEST-cli-sync-discovery-readme-ignore
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-sync-discovery-readme-ignore
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-a1e271fb70d00c4ca27e8097
    test_id: TEST-cli-sync-discovery-readme-ignore
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-sync-discovery-readme-ignore
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-8886d26d99043d067c1927e5
    test_id: TEST-cli-sync-discovery-readme-ignore
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-sync-discovery-readme-ignore
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-a4278d7ad7496849b23c04b3
    test_id: TEST-cli-sync-discovery-readme-ignore
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cli-sync-discovery-readme-ignore
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-b5b86b0fd3fb529b53b63fb5
    test_id: TEST-cli-sync-discovery-readme-ignore
    scope: end_to_end
    outcome: passed
