    ...
    proof_results:
      ...
      - symbol_id: SYM-test-packed-typed-relationship-roundtrip
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-a7a40bddc4881ae7c221e007
    test_id: TEST-kibi-entity-relationship-schema-roundtrip
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      ...
      - symbol_id: SYM-test-packed-typed-relationship-roundtrip
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-155bb7066a13e8fd00a58ecb
    test_id: TEST-kibi-entity-relationship-schema-roundtrip
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      ...
      - symbol_id: SYM-test-packed-typed-relationship-roundtrip
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-5cba401b6a50d7bf855c2ce5
    test_id: TEST-kibi-entity-relationship-schema-roundtrip
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      ...
      - symbol_id: SYM-test-packed-typed-relationship-roundtrip
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-0c6976881448dfda89c02d4b
    test_id: TEST-kibi-entity-relationship-schema-roundtrip
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      ...
      - symbol_id: SYM-test-packed-typed-relationship-roundtrip
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-6c595c5892213af01e2da410
    test_id: TEST-kibi-entity-relationship-schema-roundtrip
    scope: end_to_end
    outcome: passed
