    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-tag-filtering-server-side
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-4f219c0db6127cb59a08904b
    test_id: TEST-mcp-tag-filtering-server-side
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-tag-filtering-server-side
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-6b97b1aa9aced9d5af4fde39
    test_id: TEST-mcp-tag-filtering-server-side
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-tag-filtering-server-side
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-4ef2550ac0acb7a478acf4ae
    test_id: TEST-mcp-tag-filtering-server-side
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-tag-filtering-server-side
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-e8045f3940aa672ae77cb8f4
    test_id: TEST-mcp-tag-filtering-server-side
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-tag-filtering-server-side
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-d234c0903b551fdc9a872670
    test_id: TEST-mcp-tag-filtering-server-side
    scope: end_to_end
    outcome: passed
