    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-stop-job-vs-plan
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-537863016adcae86720895d7
    test_id: TEST-cursor-stop-job-vs-plan
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-stop-job-vs-plan
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-6f2e9c53f64af9e63278c39c
    test_id: TEST-cursor-stop-job-vs-plan
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-stop-job-vs-plan
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-58b50ef6762b7a8733a3b0f0
    test_id: TEST-cursor-stop-job-vs-plan
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-stop-job-vs-plan
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-7620570a38294a0c0b812b0a
    test_id: TEST-cursor-stop-job-vs-plan
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-cursor-stop-job-vs-plan
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-1d3d9599c64a0c38d415e7b8
    test_id: TEST-cursor-stop-job-vs-plan
    scope: end_to_end
    outcome: passed
