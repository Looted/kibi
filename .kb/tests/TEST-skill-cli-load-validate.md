    ...
    proof_results:
      - symbol_id: SYM-e2e-test-skill-cli-load-validate
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-9312f10fd8efb25f82094f48
    test_id: TEST-skill-cli-load-validate
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-skill-cli-load-validate
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-ae7d6972ba740bbcdd01dcbd
    test_id: TEST-skill-cli-load-validate
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-skill-cli-load-validate
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-2818123356bc74db8d20f1d1
    test_id: TEST-skill-cli-load-validate
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-skill-cli-load-validate
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-8bb5237bb948c3995abf7ccc
    test_id: TEST-skill-cli-load-validate
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-skill-cli-load-validate
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-6d21501ef92744ecfa1e7962
    test_id: TEST-skill-cli-load-validate
    scope: end_to_end
    outcome: passed
