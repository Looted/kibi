    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-suggest-predicates
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-08d71592f0cd8cf7523823fd
    test_id: TEST-mcp-suggest-predicates
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-suggest-predicates
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-fdb7a112aa165757e3ef2fed
    test_id: TEST-mcp-suggest-predicates
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-suggest-predicates
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-55a60eafc7a278deebe0f53e
    test_id: TEST-mcp-suggest-predicates
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-suggest-predicates
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-97048997161a1170b4bd70e4
    test_id: TEST-mcp-suggest-predicates
    scope: end_to_end
    outcome: passed
    ...
    proof_results:
      - symbol_id: SYM-e2e-test-mcp-suggest-predicates
        ...
        attempts:
          status: unavailable
  - version: kibi.proof-receipt.v1
    receipt_id: PR-261bc9ff8c5eb0d26a2285c7
    test_id: TEST-mcp-suggest-predicates
    scope: end_to_end
    outcome: passed
