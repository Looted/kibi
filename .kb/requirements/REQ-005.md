...
links:
  ...
  - type: requires_predicate
    target: FACT-FIRST-CLASS-RELATIONSHIP-TYPES
  - type: requires_predicate
    target: FACT-RELATIONSHIP-PROVENANCE-TIMESTAMP
...
semantic_inventory:
  - claim_key: CLAIM-F1464C6F21073AFF
    ...
    reason: Grounded by exact relationship-type and per-triple RDF timestamp provenance predicates.
