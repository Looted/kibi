...
semantic_inventory:
  - claim_key: CLAIM-9428F7588206E78D
    ...
    reason: No approved domain predicate schema grounds this launcher behavior; retain it as an explicit ontology gap until a reviewed schema exists.
  ...
  - claim_key: CLAIM-8B2BC645AFDF85B0
    ...
    reason: The advisor classified this contextual clause as descriptive rather than an independently grounded logical claim.
  - claim_key: CLAIM-1FD7BA6027615B74
    ...
    reason: No approved domain predicate schema grounds this exception behavior; keep it explicit for review.
