---
title: Any client that supports the open Agent Plugins standard must be able to load Ki
status: active
tags:
  - strict-lane
fact_kind: property_value
subject_key: req.req_cursor_agent_plugin_standard_v1
property_key: clause_05_any_client_that_supports_the_open_agent_plugins_
operator: eq
value_type: bool
value_bool: true
polarity: require
canonical_key: req.req_cursor_agent_plugin_standard_v1.clause_05_any_client_that_supports_the_open_agent_plugins_.eq.true
