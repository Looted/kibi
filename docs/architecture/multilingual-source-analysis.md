...
Base: `origin/develop` at `f1f437188bd9c4abc5dd0aaacbd92fac1cd142d3`. Open PRs #279 and #280 were checked for overlap before implementation; their search/telemetry and proof-runner changes are not incorporated here. PR #281 was checked when it opened during this work; its Git-hook installation changes do not overlap the owned production files in this delivery.
