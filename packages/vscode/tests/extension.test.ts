...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
  ...
  <rdf:Description rdf:about="urn:kibi:entity/REQ-001">
    ...
    <kb:tags></kb:tags>
    <kb:source>.kb/requirements/REQ-001.md</kb:source>
  </rdf:Description>
  <rdf:Description rdf:about="urn:kibi:entity/SCEN-001">
    ...
    <kb:tags></kb:tags>
    <kb:source>.kb/scenarios/SCEN-001.md</kb:source>
  </rdf:Description>
  <rdf:Description rdf:about="urn:kibi:entity/SYM-001">
    ...
    <kb:tags></kb:tags>
    <kb:source>.kb/symbols.yaml</kb:source>
...
beforeEach(() => {
  ...
  fs.mkdirSync(path.join(tmpDir, ".kb", "scenarios"), {
    recursive: true,
  });
  fs.writeFileSync(
...
test("KibiTreeDataProvider still surfaces canonical markdown when kb.rdf is missing", async () => {
  fs.rmSync(path.join(tmpDir, ".kb", "branches"), {
    recursive: true,
    force: true,
  });
  ...
  // Fallback still surfaces canonical .kb/ markdown + symbol manifest entities
  expect(roots).toHaveLength(7);
  expect(
