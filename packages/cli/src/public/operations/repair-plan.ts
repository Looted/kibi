...
const REPAIR_PHASES = {
  ...
  proof_evidence: {
    order: 80,
    objective:
      "Run the configured proof integration with kibi prove and append fresh snapshot-bound passing receipts.",
    workflowSteps: [
      "kb_status",
      "execute_proof_run",
      "kb_ingest_proof",
...
const GAP_PHASE: Readonly<Record<string, RepairPhase>> = {
  ...
  proof_snapshot_unavailable: "snapshot_runtime",
  missing_passing_e2e: "proof_evidence",
  proof_contract_mismatch: "proof_evidence",
  missing_proof_receipt: "proof_evidence",
  stale_proof_receipt: "proof_evidence",
  failed_proof_receipt: "proof_evidence",
  invalid_proof_receipt: "proof_evidence",
...
const GAP_STAGE: Readonly<Record<string, string>> = {
  ...
  missing_proof_receipt: "passing_e2e",
  stale_proof_receipt: "passing_e2e",
  failed_proof_receipt: "passing_e2e",
  invalid_proof_receipt: "passing_e2e",
  proof_contract_mismatch: "passing_e2e",
  proof_snapshot_unavailable: "passing_e2e",
  missing_executable_test_symbol: "executable_symbols",
