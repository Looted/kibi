 ...
 */
export function escapeAtom(value) {  // implements REQ-009
 ...
 */
export function toPrologAtom(value) {  // implements REQ-009
 ...
 */
export function escapeAtomContent(value) {  // implements REQ-009
    return value.replace(/'/g, "''");
}
/**
 ...
 * Output: [["a", "b", "c"], ["d", "e", "f"]]
 */
export function parseListOfLists(listStr) {  // implements REQ-009
 ...
 */
export function parseEntityFromBinding(bindingStr) {  // implements REQ-009
 ...
 * Input: ["abc123", "req", "[id=abc123, title=\"Test\", ...]"]
 */
export function parseEntityFromList(data) {  // implements REQ-009
    if (data.length < 3) {
        return {};
    }
 ...
 */
export function parsePropertyList(propsStr) {  // implements REQ-009
    const props = {};
 ...
 */
export function parseAtomList(raw) {  // implements REQ-009
 ...
 */
export function parsePairList(raw) {  // implements REQ-009
 ...
 */
export function parseTriples(raw) {  // implements REQ-009
    const rows = parseListRows(raw);
    const triples = [];
    for (const row of rows) {
        const parts = splitTopLevelGeneral(row, ",").map((part) => stripQuotes(part.trim()));
