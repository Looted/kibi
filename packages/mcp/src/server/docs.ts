...
export const PROMPTS = [
  // implements REQ-002, REQ-013, REQ-mcp-search-discovery
  {
    ...
    text: [
      ...
      "",
      "This tool is **read-only**. It returns:",
      "- `activationState`: current KB state (e.g., `root_uninitialized`)",
      "- `candidates[]`: synthesized entities grounded in declared context and source evidence",
      "- `plan`: proposed initialization strategy",
      "",
      "## Step 3: Preview and Approval",
      "",
      "Present the `plan` and a summary of `candidates` to the user. **Wait for explicit approval** before proceeding to writes.",
      "",
