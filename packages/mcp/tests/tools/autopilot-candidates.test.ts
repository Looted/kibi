...
describe("autopilot candidates", () => {
      ...
      applyPlan: [
        {
          ...
          properties: {
            ...
            title: "ADR: Runtime Choice",
            status: "proposed",
            source: "autopilot:generic:docs/notes.md",
  ...
  test("provider evidence defaults repo metadata facts to meta and lower confidence to low", () => {
    ...
    expect(candidates[0]).toMatchObject({
      ...
      entityType: "fact",
      title: "Autopilot evidence from package.json",
      ...
      applyPlan: [
        {
          ...
          properties: {
            ...
            status: "active",
            fact_kind: "meta",
            source: "autopilot:repo_metadata:package.json",
      ...
      applyPlan: [
        {
          ...
          properties: {
            fact_kind: "observation",
            source: "autopilot:source_symbols:src/service.ts",
      ...
      applyPlan: [
        {
          ...
          properties: {
            ...
            status: "active",
            fact_kind: "observation",
            source: "autopilot:source_symbols:src/service.ts#Service",
      ...
      applyPlan: [
        {
          ...
          properties: {
            ...
            status: "active",
            fact_kind: "observation",
            source: "autopilot:source_symbols:src/index.ts#exports",
