...
describe("ZCode hook input", () => {
  ...
  test("Given ZCode snake_case fields When parsing Then fields are normalized", () => {
    expect(
      parseHookInput({
  ...
  test("Given alternate host dialects When parsing Then fields are normalized", () => {
    expect(
      parseHookInput({
